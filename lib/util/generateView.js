...
module.exports = function(data){
	...
	var file = fs.readFileSync(__dirname + '/../ui/template.html', 'utf8');

	// add css into the head of the template
	var css = fs.readFileSync(__dirname + '/../ui/styles.css', 'utf8');
	file = file.replace('{{css}}', css);

	// add javascript into the head of the template
	var js = fs.readFileSync(__dirname + '/../ui/scripts.js', 'utf8');
