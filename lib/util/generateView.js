...
module.exports = function(data){
	...
	var file = fs.readFileSync(root + '/lib/template/index.html', 'utf8');

	// add css into the head of the template
	var css = fs.readFileSync(root + '/lib/template/styles.css', 'utf8');
	file = file.replace('{{css}}', css);

	// add javascript into the head of the template
	var js = fs.readFileSync(root + '/lib/template/scripts.js', 'utf8');
